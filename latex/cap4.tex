...
Para o funcionamento das atualizações algumas variáveis necessárias de sistema devem ser criadas para o acesso do kerberos com bind9.
...
Mudar o dono e o grupo do dns.keytab para que o bind9 possa alterar o arquivo.
