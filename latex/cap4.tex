...
Entrar no diretório onde se encontra os arquivos de configuração do bind9.
...
\begin{itemize}
	...
	%\item \textbf{\# chown named:named /usr/local/samba/private/dns.keytab} - Modifica o usuário e grupo proprietário do arquivo;
...
Configurar atualizações dinâmicas no DNS com o kerberos. Para o funcionamento das atualizações algumas variáveis necessárias de sistema devem ser criadas para o acesso do kerberos com bind9.
...
\begin{itemize}
	...
	\item \textbf{\# chown named:named /usr/local/samba/private/dns.keytab} - Mudar o dono e o grupo do dns.keytab para que o bind9 possa alterar o arquivo.
...
\section{Samba3 e Samba 4 na rede}
