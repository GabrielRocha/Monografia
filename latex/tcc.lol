...
\contentsline {lstlisting}{\numberline {3.9}Vari\IeC {\'a}veis para permitir impress\IeC {\~a}o em impressoras compartilhadas}{40}{lstlisting.listoftables.3.9}
\contentsline {lstlisting}{\numberline {3.10}Vari\IeC {\'a}veis para compartilhar impressoras}{41}{lstlisting.listoftables.3.10}
\contentsline {lstlisting}{\numberline {3.11}Vari\IeC {\'a}veis para compartilhamento onde dever\IeC {\~a}o ficar os \textit {drivers} das impressoras}{42}{lstlisting.listoftables.3.11}
\contentsline {lstlisting}{\numberline {3.12}Arquivo smb.conf com as vari\IeC {\'a}veis necess\IeC {\'a}rias para fazer login em um dom\IeC {\'\i }nio}{49}{lstlisting.listoftables.3.12}
\contentsline {lstlisting}{\numberline {3.13}Arquivo nsswitch.conf}{51}{lstlisting.listoftables.3.13}
\contentsline {lstlisting}{\numberline {3.14}Resultado quando a m\IeC {\'a}quina \IeC {\'e} adicionada com sucesso no dom\IeC {\'\i }nio}{52}{lstlisting.listoftables.3.14}
