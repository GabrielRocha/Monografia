...
\begin{itemize}
	...
	\item \textbf{\netbios name} - Nome do computador cliente, que deve estar cadastrado no servidor.
...
Após a configuração do Samba, deve-se configurar o arquivo Network Services Switch (\textbf{\/etc/nsswitch.conf}), que determina a ordem das buscas quando uma informação é solicitada. Esse arquivo deve ter as seguintes linhas alteradas:
