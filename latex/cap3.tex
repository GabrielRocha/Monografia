...
\begin{lstlisting}[caption=Exemplo do que deve ser inserido no smb.conf,label={global}]	
[home]
...
Agora é necessário inserir, modificar e remover alguns parâmetros na seção [global] para que o Samba 3 se comporte como um PDC. Conforme o Quadro \ref{global}\\
...
\textbf{Exemplo da aplicação de algumas das variáveis citadas acima }\\
...
Exemplo de um script diretoria.bat e seu resultado na Figura \ref{mapeamento}\\
