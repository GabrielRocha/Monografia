...
\begin{figure}[ht]
   	\centering
    \includegraphics[width=0.9 \textwidth]{figuras/mapeamento}
...
\begin{figure}[h!]
   	\centering
    \includegraphics[width=0.8 \textwidth]{figuras/mapeamento}
   	\caption{Tela de um mapeamento}
    \label{mapeamento}
\end{figure}
...
\begin{figure}[h!]
   	\centering
    \includegraphics[width=0.6 \textwidth]{figuras/mapeamento}
   	\caption{Tela de um mapeamento}
    \label{mapeamento}
\end{figure}
...
\begin{figure}[h!]
   	\centering
    \includegraphics[width=0.5 \textwidth]{figuras/mapeamento}
   	\caption{Tela de um mapeamento}
    \label{mapeamento}
\end{figure}
...
\pagebreak
	...
	\begin{figure}[ht]
	   	\centering
	    \includegraphics[width=0.6 \textwidth]{figuras/impressora_aparelho_fax}
...
%	\pagebreak
	...
	\begin{figure}[ht]
	   	\centering
	     \includegraphics[width=0.5 \textwidth]{figuras/selecionar_driver}
	...
	\begin{figure}[ht]
	   	\centering
	     \includegraphics[width=0.5 \textwidth]{figuras/selecionar_so}
	...
	\begin{figure}[ht]
	   	\centering
	     \includegraphics[width=0.8 \textwidth]{figuras/opcao_nao}
	...
	\begin{figure}[ht]
	   	\centering
	     \includegraphics[width=0.5 \textwidth]{figuras/aba_avancado}
	...
	\begin{figure}[ht]
	   	\centering
	     \includegraphics[width=0.5 \textwidth]{figuras/login_dominio}
	...
	\begin{figure}[ht]
	   	\centering
	     \includegraphics[width=0.5 \textwidth]{figuras/selecionar_impressora_servidor}
...
%	\pagebreak
	...
	\begin{figure}[ht]
	   	\centering
	     \includegraphics[width=0.5 \textwidth]{figuras/impressora_compartilhada}
...
\begin{enumerate}
	...
	\item {Acessar a aba ``Nome do Computador". Deve-se clicar no botão ``Alterar". - Figura \ref{alterar_nome_micro}}
		...
		\begin{figure}[ht]
	   			\centering
	   		 	\includegraphics[width=0.5 \textwidth]{figuras/alterar_nome_micro}
	...
	\item {No menu de ``Alterações de nome do computador", certifique-se de que o nome definido para o computador é o mesmo que foi cadastrado no servidor Samba 3. No campo ``Membro de", selecione a opção ``Domínio" e digite o nome do domínio definido na sessão [global] do Samba 3 e depois clique em OK. - Figura \ref{incluir_dominio}} 
			\begin{figure}[ht]
		   			\centering
		   		 	\includegraphics[width=0.5 \textwidth]{figuras/incluir_dominio}
	...
	\begin{figure}[ht]
			\centering
	 		\includegraphics[width=0.5 \textwidth]{figuras/logon}
