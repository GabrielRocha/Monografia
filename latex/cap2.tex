...
o NetBIOS trabalha na camada sessão do modelo OSI, e utiliza as portas de comunicação UDP 137 e 138 para a resolução dos NetBios \textit{names} e \textit{datagrams}, conforme a figura \ref{NETBIOS}
