...
Além da função de servidor de arquivos, o Samba pode ser usando também como Controlador de Domínio ou DC (\textit{Domain Controller}), também conhecido como Controlador de Domínio Primário ou PDC (\textit{Primary Domain Controller}) \cite{MORIMOTO}.
